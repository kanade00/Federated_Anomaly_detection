...
def cifar10(
    data_dir, batch_size=32, mode="base", normalize=True, norm_layer=None, size=32, ratio_pollution=0.0
):
    """
    mode: org | base | ssl
    """
    ...
    trainset = concat_set([cifar10_set, cifar100_set])

    return trainset, testset, norm_layer
